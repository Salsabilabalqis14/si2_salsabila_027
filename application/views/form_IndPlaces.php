                ...
                <main>
                    <div class="container" style="margin-top:20px">
                        <div class="col-lg-12 text-center mb-5">
                            <h1>Tambah Data Indonesia Places</h1>
                        </div>

                        <div class="position-absolute start-50 translate-middle " style="margin-top: 50px; margin-left:130px;">
                        <form action="<?php echo base_url('data_IndPlaces/tambah'); ?>" method="POST" enctype="multipart/form-data">
                            <table class="tabel">
                            <tr>
                                <td>Nama Tempat</td>
                                <td>:</td>
                            ...
                            <tr>
                                ...
                                <td>:</td>
                                <td>
                                    <input type="file" name="input_gambar" style="border:none;">
                                </td>
                            </tr>
                            <tr>
                                <td>&nbsp;</td>
