            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container" style="margin-top:20px">
                        ...
                        <a href="<?php echo base_url('dataPlaces/add_data'); ?>" class="btn btn-primary">Tambah Data</a>
                        ...
                        <table class="table table-striped" style="text-align: center; margin-top:20px;">
                            ...
                            <?php 
                                ...
                                <tr> 
                                    <td><?php echo $places['id']; ?></td> 
                                    <td><?php echo $places['nama_tempat']; ?></td> 
                                    <td><?php echo $places['provinsi']; ?></td> 
                                    <td><?php echo $places['negara']; ?></td> 
                                    <td><?php echo $places['rating']; ?></td> 
                                    <td><?php echo $places['deskripsi']; ?></td> 
                                    <td>
                                        <a href="<?php echo base_url('dataPlaces/edit_data/'.$places['id']); ?>" class="btn btn-secondary btn-sm">Edit</a>
                                        <a href="<?php echo base_url('dataPlaces/delete_data/'.$places['id']); ?>" class="btn btn-danger btn-sm">Hapus</a>
                                    </td>
                                </tr> 
                            <?php }
                                }
