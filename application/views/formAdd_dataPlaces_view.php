            ...
            <div id="layoutSidenav_content">
                <main>
                    ...
                    <div class="col-lg-12 text-center mb-5">
                        <h1>Tambah Data Places</h1>
                    </div>
                    <?php echo form_open('dataPlaces/insert'); ?>
                    <div class="position-absolute start-50 translate-middle " style="margin-top: 80px; margin-left:120px;">
                        <form action="<?php echo base_url('dataPlaces/insert'); ?>" method="POST">
                            <table class="tabel">
                            <tr>
                                <td>Nama Tempat</td>
                                <td>:</td>
                                <td>
                                    <?php echo form_error('nama_tempat');?> 
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <input type="text" name="rating" value="<?php echo set_value('rating');?>" >
                                </td>
                            </tr>                            
                            <tr>
                                <td>Deskripsi</td>
                                ...
                                <td>
                                    ...
                                    <input type="text" name="deskripsi" value="<?php echo set_value('deskripsi');?>" >
                                </td>
                            </tr>
                            <tr>
                                <td>&nbsp;</td>
                                <td></td>
                                <td><input type="submit" name="submit" class="btn btn-primary" value="Simpan" style="margin-left: 30px;"></td>
                            </tr>
                            </table>
                        </form>
                    </div>
